...
//
//	mockgen -source=./apps/tierlist/internal/infrastructure/repository/season_repository.go -destination=./apps/tierlist/internal/infrastructure/repository/repository_mock_test.go -package=repository_test
//
